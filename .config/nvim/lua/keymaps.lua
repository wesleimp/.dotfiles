...
-- Telescope
--------------------------------------------------
nmap("<C-p>", ":lua require('telescope.builtin').find_files()<cr>", { noremap = true })
nmap("<C-f>", ":lua require('telescope.builtin').live_grep({ hidden = true })<cr>", { noremap = true })
nmap("<C-b>", ":lua require('telescope.builtin').buffers()<cr>", { noremap = true })
nmap("<leader>fs", ":lua require('telescope.builtin').grep_string({search = vim.fn.expand('<cword>')})<CR>", { noremap = true })
nmap("<leader>gs", ":lua require('telescope.builtin').git_status()<cr>", { noremap = true })
nmap("<leader>gb", ":lua require('telescope.builtin').git_branches()<cr>", { noremap = true })
nmap("<leader>gc", ":lua require('telescope.builtin').git_commits()<cr>", { noremap = true })
